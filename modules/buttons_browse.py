...
def browseFile51(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName51, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName51, TAB.in_, 51)

    if TAB.fileName51 != "":
        pixmap = QPixmap(TAB.fileName51)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[50].setPixmap(pixmap)
        TAB.grids[10].addWidget(TAB.label_left[50], 0, 2, 1, 1)
    else:
        pass

def browseFile52(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName52, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName52, TAB.in_, 52)

    if TAB.fileName52 != "":
        pixmap = QPixmap(TAB.fileName52)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[51].setPixmap(pixmap)
        TAB.grids[10].addWidget(TAB.label_left[51], 1, 2, 1, 1)
    else:
        pass

def browseFile53(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName53, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName53, TAB.in_, 53)

    if TAB.fileName53 != "":
        pixmap = QPixmap(TAB.fileName53)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[52].setPixmap(pixmap)
        TAB.grids[10].addWidget(TAB.label_left[52], 2, 2, 1, 1)
    else:
        pass

def browseFile54(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName54, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName54, TAB.in_, 54)

    if TAB.fileName54 != "":
        pixmap = QPixmap(TAB.fileName54)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[53].setPixmap(pixmap)
        TAB.grids[10].addWidget(TAB.label_left[53], 3, 2, 1, 1)
    else:
        pass

def browseFile55(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName55, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName55, TAB.in_, 55)

    if TAB.fileName55 != "":
        pixmap = QPixmap(TAB.fileName55)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[54].setPixmap(pixmap)
        TAB.grids[10].addWidget(TAB.label_left[54], 4, 2, 1, 1)
    else:
        pass

def browseFile56(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName56, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName56, TAB.in_, 56)

    if TAB.fileName56 != "":
        pixmap = QPixmap(TAB.fileName56)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[55].setPixmap(pixmap)
        TAB.grids[11].addWidget(TAB.label_left[55], 0, 2, 1, 1)
    else:
        pass

def browseFile57(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName57, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName57, TAB.in_, 57)

    if TAB.fileName57 != "":
        pixmap = QPixmap(TAB.fileName57)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[56].setPixmap(pixmap)
        TAB.grids[11].addWidget(TAB.label_left[56], 1, 2, 1, 1)
    else:
        pass

def browseFile58(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName58, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName58, TAB.in_, 58)

    if TAB.fileName58 != "":
        pixmap = QPixmap(TAB.fileName58)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[57].setPixmap(pixmap)
        TAB.grids[11].addWidget(TAB.label_left[57], 2, 2, 1, 1)
    else:
        pass

def browseFile59(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName59, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName59, TAB.in_, 59)

    if TAB.fileName59 != "":
        pixmap = QPixmap(TAB.fileName59)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[58].setPixmap(pixmap)
        TAB.grids[11].addWidget(TAB.label_left[58], 3, 2, 1, 1)
    else:
        pass

def browseFile60(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName60, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName60, TAB.in_, 60)

    if TAB.fileName60 != "":
        pixmap = QPixmap(TAB.fileName60)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[59].setPixmap(pixmap)
        TAB.grids[11].addWidget(TAB.label_left[59], 4, 2, 1, 1)
    else:
        pass

def browseFile61(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName61, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName61, TAB.in_, 61)

    if TAB.fileName61 != "":
        pixmap = QPixmap(TAB.fileName61)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[56].setPixmap(pixmap)
        TAB.grids[12].addWidget(TAB.label_left[60], 0, 2, 1, 1)
    else:
        pass

def browseFile62(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName62, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName62, TAB.in_, 62)

    if TAB.fileName62 != "":
        pixmap = QPixmap(TAB.fileName62)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[61].setPixmap(pixmap)
        TAB.grids[12].addWidget(TAB.label_left[61], 1, 2, 1, 1)
    else:
        pass

def browseFile63(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName63, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName63, TAB.in_, 63)

    if TAB.fileName63 != "":
        pixmap = QPixmap(TAB.fileName63)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[62].setPixmap(pixmap)
        TAB.grids[12].addWidget(TAB.label_left[62], 2, 2, 1, 1)
    else:
        pass

def browseFile64(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName64, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName64, TAB.in_, 64)

    if TAB.fileName64 != "":
        pixmap = QPixmap(TAB.fileName64)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[63].setPixmap(pixmap)
        TAB.grids[12].addWidget(TAB.label_left[63], 3, 2, 1, 1)
    else:
        pass

def browseFile65(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName65, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName65, TAB.in_, 65)

    if TAB.fileName65 != "":
        pixmap = QPixmap(TAB.fileName65)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[64].setPixmap(pixmap)
        TAB.grids[12].addWidget(TAB.label_left[64], 4, 2, 1, 1)
    else:
        pass

def browseFile66(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName66, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName66, TAB.in_, 66)

    if TAB.fileName66 != "":
        pixmap = QPixmap(TAB.fileName66)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[65].setPixmap(pixmap)
        TAB.grids[13].addWidget(TAB.label_left[65], 0, 2, 1, 1)
    else:
        pass

def browseFile67(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName67, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName67, TAB.in_, 67)

    if TAB.fileName67 != "":
        pixmap = QPixmap(TAB.fileName67)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[66].setPixmap(pixmap)
        TAB.grids[13].addWidget(TAB.label_left[66], 1, 2, 1, 1)
    else:
        pass

def browseFile68(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName68, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName68, TAB.in_, 68)

    if TAB.fileName68 != "":
        pixmap = QPixmap(TAB.fileName68)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[67].setPixmap(pixmap)
        TAB.grids[13].addWidget(TAB.label_left[67], 2, 2, 1, 1)
    else:
        pass

def browseFile69(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName69, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName69, TAB.in_, 69)

    if TAB.fileName69 != "":
        pixmap = QPixmap(TAB.fileName69)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[68].setPixmap(pixmap)
        TAB.grids[13].addWidget(TAB.label_left[68], 3, 2, 1, 1)
    else:
        pass

def browseFile70(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName70, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName70, TAB.in_, 70)

    if TAB.fileName70 != "":
        pixmap = QPixmap(TAB.fileName70)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[69].setPixmap(pixmap)
        TAB.grids[13].addWidget(TAB.label_left[69], 4, 2, 1, 1)
    else:
        pass

def browseFile71(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName71, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName71, TAB.in_, 71)

    if TAB.fileName71 != "":
        pixmap = QPixmap(TAB.fileName71)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[70].setPixmap(pixmap)
        TAB.grids[14].addWidget(TAB.label_left[70], 0, 2, 1, 1)
    else:
        pass

def browseFile72(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName72, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName72, TAB.in_, 72)

    if TAB.fileName72 != "":
        pixmap = QPixmap(TAB.fileName72)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[71].setPixmap(pixmap)
        TAB.grids[14].addWidget(TAB.label_left[71], 1, 2, 1, 1)
    else:
        pass

def browseFile73(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName73, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName73, TAB.in_, 73)

    if TAB.fileName73 != "":
        pixmap = QPixmap(TAB.fileName73)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[72].setPixmap(pixmap)
        TAB.grids[14].addWidget(TAB.label_left[72], 2, 2, 1, 1)
    else:
        pass

def browseFile74(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName74, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName74, TAB.in_, 74)

    if TAB.fileName74 != "":
        pixmap = QPixmap(TAB.fileName74)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[73].setPixmap(pixmap)
        TAB.grids[14].addWidget(TAB.label_left[73], 3, 2, 1, 1)
    else:
        pass

def browseFile75(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName75, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName75, TAB.in_, 75)

    if TAB.fileName75 != "":
        pixmap = QPixmap(TAB.fileName75)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[74].setPixmap(pixmap)
        TAB.grids[14].addWidget(TAB.label_left[74], 4, 2, 1, 1)
    else:
        pass

def browseFile76(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName76, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName76, TAB.in_, 76)

    if TAB.fileName76 != "":
        pixmap = QPixmap(TAB.fileName76)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[75].setPixmap(pixmap)
        TAB.grids[15].addWidget(TAB.label_left[75], 0, 2, 1, 1)
    else:
        pass

def browseFile77(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName77, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName77, TAB.in_, 77)

    if TAB.fileName77 != "":
        pixmap = QPixmap(TAB.fileName77)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[76].setPixmap(pixmap)
        TAB.grids[15].addWidget(TAB.label_left[76], 1, 2, 1, 1)
    else:
        pass

def browseFile78(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName78, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName78, TAB.in_, 78)

    if TAB.fileName78 != "":
        pixmap = QPixmap(TAB.fileName78)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[77].setPixmap(pixmap)
        TAB.grids[15].addWidget(TAB.label_left[77], 2, 2, 1, 1)
    else:
        pass

def browseFile79(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName79, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName79, TAB.in_, 79)

    if TAB.fileName79 != "":
        pixmap = QPixmap(TAB.fileName79)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[78].setPixmap(pixmap)
        TAB.grids[15].addWidget(TAB.label_left[78], 3, 2, 1, 1)
    else:
        pass

def browseFile80(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName80, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName80, TAB.in_, 80)

    if TAB.fileName80 != "":
        pixmap = QPixmap(TAB.fileName80)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[79].setPixmap(pixmap)
        TAB.grids[15].addWidget(TAB.label_left[79], 4, 2, 1, 1)
    else:
        pass

def browseFile81(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName81, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName81, TAB.in_, 81)

    if TAB.fileName81 != "":
        pixmap = QPixmap(TAB.fileName81)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[80].setPixmap(pixmap)
        TAB.grids[16].addWidget(TAB.label_left[80], 0, 2, 1, 1)
    else:
        pass

def browseFile82(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName82, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName82, TAB.in_, 82)

    if TAB.fileName82 != "":
        pixmap = QPixmap(TAB.fileName82)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[81].setPixmap(pixmap)
        TAB.grids[16].addWidget(TAB.label_left[81], 1, 2, 1, 1)
    else:
        pass

def browseFile83(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName83, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName83, TAB.in_, 83)

    if TAB.fileName83 != "":
        pixmap = QPixmap(TAB.fileName82)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[82].setPixmap(pixmap)
        TAB.grids[16].addWidget(TAB.label_left[82], 2, 3, 1, 1)
    else:
        pass

def browseFile84(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName84, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)

    save_image(TAB.fileName84, TAB.in_, 84)

    if TAB.fileName84 != "":
        pixmap = QPixmap(TAB.fileName84)
        pixmap = pixmap.scaled(TAB.width, TAB.height, Qt.KeepAspectRatio, Qt.FastTransformation)
        TAB.label_left[83].setPixmap(pixmap)
        TAB.grids[16].addWidget(TAB.label_left[83], 3, 3, 1, 1)
    else:
        pass

def browseFile85(TAB):
    options = QFileDialog.Options()
    options |= QFileDialog.DontUseNativeDialog
    TAB.fileName85, _ = QFileDialog.getOpenFileName(TAB, "Select File", "", "All Files (*)", options=options)
